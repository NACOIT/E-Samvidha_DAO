...
import gov.naco.soch.entity.TIBenBasicDetailsForMobile;
import gov.naco.soch.projection.SurveyProjection;

@Repository
public interface TiBenBasicDetailsRepositoryForMobile
		extends JpaRepository<TIBenBasicDetailsForMobile, Long>, JpaSpecificationExecutor<TIBenBasicDetailsForMobile> {
	...
	List<SurveyProjection> getSurveyDetails(Long id);
