...
@NamedQuery(name="MasterNotificationEventType.findAll", query="SELECT m FROM MasterNotificationEventType m")
public class MasterNotificationEventType {
	...
	@OneToMany(mappedBy="masterNotificationEventType")
