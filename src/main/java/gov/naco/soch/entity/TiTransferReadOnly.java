...
@NamedEntityGraph(name = "TiTransferReadOnlyEntityGraph")
@Entity(name = "TiTransferReadOnly")
@Table(name = "transfers")
@NamedQuery(name = "TiTransferReadOnly.findAll", query = "SELECT t FROM TiTransferReadOnly t")
@Immutable
public class TiTransferReadOnly  extends Auditable<Long> implements Serializable {
	...
	private TiBeneficiaryTransferReadOnly tiBeneficiary;
	...
	public TiBeneficiaryTransferReadOnly getTiBeneficiary() {
		return tiBeneficiary;
	}

	public void setTiBeneficiary(TiBeneficiaryTransferReadOnly tiBeneficiary) {
